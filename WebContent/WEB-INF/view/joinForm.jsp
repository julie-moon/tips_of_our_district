...
<c:import url="/WEB-INF/view/template/header.jsp"></c:import>
            ...
            <div id="formBox">
                <form method="post" action="main.gt">
                    <fieldset>
                        <div class="row">
                            <input id="id" title="아이디를 입력하세요" placeholder="아이디 입력" />
                            <div class="failMsg">이미 존재하는 아이디입니다.</div>
                            <div class="successMsg">멋진 아이디네요~!</div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="successMsg">멋진 닉네임이네요~!</div>
                        </div><!--//.row -->
                        <div class="row">
                            <input id="email" title="이메일을 입력하세요" placeholder="이메일 입력" />
                            <div class="failMsg">이미 등록된 이메일입니다.</div>
                            <div class="successMsg"></div>
                        </div><!--//.row -->
                        <div class="row">
                            <span class="messageBirth">출생 년도는 선택하신 후 수정이 불가능해요~!</span>
                            <input id="birthYear" title="출생년도를 입력하세요" placeholder="출생년도 입력(숫자로만)" />
                            <div class="failMsg">숫자로만 입력 가능합니다.</div>
                        </div><!--//.row -->
...
<script>
    ...
    /* var idReg = /^[\w]{4,10}$/;
     ...
     $('#id').onkeyup(checkId); // .row onkeyup end

     $('#id').click(function () {
         function checkId() {
             var checkUser = $(this).next('.failMsg');
