...
<head>
    ...
    <style>
        ...
        /*#tip_category_title li{*/
            ...
            /*border-right:1px solid #424242;*/
        /*!*}*!*/
        /*#tip_category_title li:first-child{*/
            /*margin-left:0;*/
        /*}*/
        /*#tip_category_title li:last-child{*/
            /*border:0;*/
        /*}*/
        .on{
            color:#FEBD39;
...
<c:import url="/WEB-INF/view/template/header.jsp"></c:import>
            ...
            <div id="contentSection">
                ...
                <div class="tip_category_title">
                    ...
                    <li><a href="">주거시설</a></li>
                    <li><a href="">육아</a></li>-->
                    <h3><span class="on">자유게시판</span> 인기글</h3>
                </div>

                <ul class="ggultip_list">
                    <li class="ggultip">
                        <p class="board_name">랭킹</p>
                ...
                <div class="tip_category_title">
                    ...
                    <li><a href="">주거시설</a></li>
                    <li><a href="">육아</a></li>-->
                    <h3><span class="on">행사</span> 인기글</h3>
                </div>
                ...
                <div class="tip_category_title">
                    ...
                    <li><a href="">주거시설</a></li>
                    <li><a href="">육아</a></li>-->
                    <h3><span class="on">교통</span> 인기글</h3>
                </div>
                ...
                <div class="tip_category_title">
                    ...
                    <li><a href="">주거시설</a></li>
                    <li><a href="">육아</a></li>-->
                    <h3><span class="on">주거시설</span> 인기글</h3>
                </div>
                ...
                <div class="tip_category_title">
                    ...
                    <li><a href="">주거시설</a></li>
                    <li><a href="">육아</a></li>-->
                    <h3><span class="on">육아</span> 인기글</h3>
                </div>
                ...
                <div id="search">
                    ...
                    <input type="text" placeholder="게시판 내에서 검색">&lt;!&ndash;
